...
> Vendored copy of the upstream OKF v0.1 specification for offline, self-contained
> use by the `okf-update-notes` skill. Source:
> https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
> Refresh manually when the upstream format revises.
